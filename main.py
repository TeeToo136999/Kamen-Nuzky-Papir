...
def main():
    ...
    vyber = ["Kámen", "kámen", "Kamen", "kamen", "Papír", "papír",
             "Papir", "papir", "Nužky", "nužky", "Nuzky", "nuzky"]
    Ty = 0
    Pc = 0
    ...
    while Ty < 5 and Pc < 5:
        ...
        if user_action in vyber:
            print(
                f"\nTvoje volba {user_action}, Volba počítače {computer_action}.\n")
            if user_action == computer_action:
                print(
                    f"Oba jste vybrali stejný znak {user_action}. Je to remíza!")
